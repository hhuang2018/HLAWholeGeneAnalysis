...
logfile_fp = "../Output/SG41_52/logfiles_12072017/"
...
all_DB_files = glob.glob("../Output//SG41_52//originalDB_12072017/*.db")
...
for db_file in all_DB_files:
    ...
    new_db_fp = "../Output/SG41_52/AvailDB/SG41_52_HLA_"+ locus +"_avail.db"
