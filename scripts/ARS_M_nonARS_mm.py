...
out_fp = '../Output/SG39/2018/SG39_Stats/fiveLoci_paired_cases_0328/' # /fiveLoci_paired_cases/ ; allLoci_paired_cases
Loci_num = 'fiveLoci_'
for locus in Five_loci:
    with open(out_fp +'AllField/MisMatchCases/HLA_'+locus+'_'+Loci_num+'PairedCases_corrected_wNonSyn_0328.csv', 'w+') as csv_file:
    ...
    with open(out_fp + 'TwoField/MisMatchCases/HLA_'+locus+'_'+Loci_num+'PairedCases_corrected_wNonSyn_0328.csv', 'w+') as csv_file:
        writer = csv.writer(csv_file)
...
### Write to csv
out_fp = '../Output/SG39/2018/SG39_Stats/fiveLoci_paired_cases_0328/' 
for locus in Five_loci:
